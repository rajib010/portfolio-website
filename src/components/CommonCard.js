...
const CommonProjectCard = ({ Information, Cardtitle }) => {
    ...
    return (React.createElement("div", { className: "container" },
        React.createElement("h1", { className: "text-left text-2xl font-bold my-5 ml-6 md:ml-11 lg:ml-16" }, Cardtitle),
        React.createElement("div", { className: "w-[90%] mx-auto grid grid-cols-2 md:grid-cols-3 gap-4" }, Information.map((item) => {
        ...
        showSheet && selectedProject && (React.createElement("div", { className: "fixed top-12 md:top-6 lg:top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-black  bg-opacity-50" },
            React.createElement("div", { className: "bg-white dark:bg-slate-800 p-8 rounded-lg w-[80%] max-w-4xl" },
                ...
                React.createElement("div", { className: "my-4" },
                    ...
                    selectedProject.technologies && React.createElement("p", { className: "my-1 text-[16px] md:text-[16px] line-clamp-3" },
                        React.createElement("span", { className: "font-semibold " }, "Technologies:"),
                        " ",
