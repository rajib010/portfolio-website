...
const PHPProjectsComponent = () => {
    ...
    return (React.createElement("div", { className: "container" },
        React.createElement("h1", { className: "text-left text-3xl font-bold my-5 ml-16" }, "PHP Projects"),
        React.createElement("div", { className: "w-[90%] mx-auto grid grid-cols-3 md:grid-cols-4 gap-4" }, PHPProjects.map((item) => {
