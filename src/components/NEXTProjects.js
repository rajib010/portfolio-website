...
const NEXTProjectsComponent = () => {
    ...
    return (React.createElement("div", { className: "container" },
        React.createElement("h1", { className: "text-left text-2xl font-bold my-5 ml-6 md:ml-11 lg:ml-16" }, "NEXT Projects"),
        React.createElement("div", { className: "w-[90%] mx-auto grid grid-cols-2 md:grid-cols-3 gap-4" }, NEXTProjects.map((item) => {
