...
const EducationalBackgroundComponent = () => {
    return (React.createElement("div", { className: "container mt-5" },
        ...
        React.createElement("div", { className: "w-[90%] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" }, EducationalBackground && EducationalBackground.map((item) => (React.createElement(Card, { key: item.id, className: "rounded-lg p-4 text-center cursor-pointer shadow-xl tansistion hover:-translate-y-1" },
