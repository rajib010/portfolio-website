...
const Card = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { ref: ref, className: cn("rounded-lg border bg-card text-card-foreground shadow-sm", className), ...props })));
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { ref: ref, className: cn("text-2xl font-semibold leading-none tracking-tight", className), ...props })));
