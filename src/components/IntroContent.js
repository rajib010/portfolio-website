...
const IntroContent = () => {
    return (React.createElement("div", { className: "w-[90%] mx-auto flex flex-col lg:flex-row lg:justify-between items-center py-5 gap-5" },
        ...
        React.createElement("div", { className: "w-full lg:w-[60%] text-center lg:text-left flex flex-col gap-4" },
            ...
            React.createElement(Button, { className: "w-full lg:w-auto" },
